...
L10N: dict[str, dict[str, str]] = {
  ...
  "goal_invalid":     "\u26a0\ufe0f Please give a valid goal amount, e.g. \"goal: save 20000 for Eid\".",
        ...
        "referral_link_sent": "🎁 Invite a friend! Share this link — when they log their first expense, you both get 7 days of Premium free:\n{link}",
        "referral_welcome": "👋 Welcome to SarrafBot! A friend invited you. Log your first expense to unlock 7 days of Premium free for both of you!",
        "already_referred": "You've already used a referral bonus before, so this one won't count — but thanks for using SarrafBot! 😊",
        "referral_already_claimed": "Your friend already redeemed a referral bonus before, so this invite didn't count this time.",
        "referral_reward_granted": "🎉 You earned 7 days of Premium free, thanks to your referral!",
  ...
  "goal_invalid":     "\u26a0\ufe0f Sahi goal amount batayein, jaise \"goal: 20000 save karne hain Eid ke liye\".",
        ...
        "referral_link_sent": "🎁 Ek dost ko invite karein! Yeh link share karein — jab woh apna pehla expense log karein, aap dono ko 7 din ki Premium free milegi:\n{link}",
        "referral_welcome": "👋 SarrafBot mein khushamdeed! Aapko ek dost ne invite kiya hai. Apna pehla expense log karein aur 7 din ki free Premium unlock karein — aap dono ke liye!",
        "already_referred": "Aap pehle hi ek referral bonus use kar chuke hain, isliye yeh count nahi hoga — lekin SarrafBot use karne ka shukriya! 😊",
        "referral_already_claimed": "Aapke dost ne pehle hi ek referral bonus le liya hai, isliye yeh invite is baar count nahi hua.",
        "referral_reward_granted": "🎉 Aapki referral ki wajah se 7 din ki Premium free mil gayi!",
  ...
  "goal_invalid":     "\u26a0\ufe0f \u0628\u0631\u0627\u06c1 \u06a9\u0631\u0645 \u062f\u0631\u0633\u062a \u06c1\u062f\u0641 \u06a9\u06cc \u0631\u0642\u0645 \u0628\u062a\u0627\u0626\u06cc\u06ba\u060c \u062c\u06cc\u0633\u06d2 \"goal: \u0639\u06cc\u062f \u06a9\u06d2 \u0644\u06cc\u06d2 20000 \u0628\u0686\u0627\u0646\u06d2 \u06c1\u06cc\u06ba\".",
        ...
        "referral_link_sent": "🎁 کسی دوست کو مدعو کریں! یہ لنک شیئر کریں — جب وہ اپنا پہلا خرچہ لاگ کریں، آپ دونوں کو 7 دن کی پریمیم مفت ملے گی:\n{link}",
        "referral_welcome": "👋 سرّاف بوٹ میں خوش آمدید! آپ کو ایک دوست نے مدعو کیا ہے۔ اپنا پہلا خرچہ لاگ کریں اور 7 دن کی مفت پریمیم حاصل کریں — آپ دونوں کے لیے!",
        "already_referred": "آپ پہلے ہی ایک ریفرل بونس استعمال کر چکے ہیں، اس لیے یہ شمار نہیں ہوگا — لیکن سرّاف بوٹ استعمال کرنے کا شکریہ! 😊",
        "referral_already_claimed": "آپ کے دوست نے پہلے ہی ایک ریفرل بونس لے لیا ہے، اس لیے یہ دعوت اس بار شمار نہیں ہوئی۔",
        "referral_reward_granted": "🎉 آپ کے ریفرل کی وجہ سے 7 دن کی پریمیم مفت مل گئی!",
  ...
  "goal_invalid":     "\u26a0\ufe0f Sahi goal amount dasso, jiven \"goal: Eid layi 20000 save karne ne\".",
        ...
        "referral_link_sent": "🎁 Kise dost nu invite karo! Eh link share karo — jado oh apna pehla kharch log karega, tuhanu dovan nu 7 din di Premium free milegi:\n{link}",
        "referral_welcome": "👋 SarrafBot vich khush amdeed! Tuhanu ik dost ne invite kita ae. Apna pehla kharch log karo te 7 din di free Premium unlock karo — tuhade dovan layi!",
        "already_referred": "Tusi pehlan hi ik referral bonus use kar chuke ho, is layi eh count nahi hovega — par SarrafBot use karan da shukriya! 😊",
        "referral_already_claimed": "Tuhade dost ne pehlan hi ik referral bonus lai lita ae, is layi eh invite es waari count nahi hoya.",
        "referral_reward_granted": "🎉 Tuhadi referral karke 7 din di Premium free mil gayi!",
    ...
    "pa": {
        "logged":          "✅ لکھ لیا: {desc} ({sign}{amt:g} روپے)",
        "balance_line":    "💰 بیلنس: {bal:g} روپے",
        "balance_full":    "💰 تہاڈا بیلنس: {bal:g} روپے\n• کل آمدن: +{inc:g} روپے\n• کل خرچہ: -{exp:g} روپے",
        "budget_status":   "{cat}: {spent:g}/{limit:g} روپے اس مہینے{flag}",
        "over_budget":     " ⚠️ بجٹ توں ودھ!",
        "near_limit":      " ⚠️ حد دے نیڑے",
        "budget_set":      "🎯 بجٹ سیٹ ہو گیا: {amt:g} روپے {period} — {cat}۔",
        "no_budget":       "📊 {scope} لئی کوئی بجٹ سیٹ نئیں۔ ایویں سیٹ کرو: \"کھانے دا بجٹ 5000\"۔",
        "any_category":    "کسے وی کیٹیگری",
        "your_budgets":    "📊 تہاڈے بجٹس:",
        "your_budget":     "📊 تہاڈا بجٹ:",
        "budget_row":      "• {cat} ({period}): {spent:g}/{limit:g} روپے {when}، {rem:g} باقی ({pct:.0f}%){flag}",
        "goal_invalid":     "⚠️ صحیح گول امونٹ دسو، جیویں \"عید لئی 20000 سیو کرنے نیں\"۔",
        "goal_set": "🎯 گول سیٹ ہو گیا: {name} — {amt:g} روپے سیو کرنے نیں۔ جدوں وی پیسے بچاؤ، '{name} لئی 500 سیو کیتے' لکھ دیو۔",
        "no_goals":         "📊 ہالے کوئی سیونگز گول سیٹ نئیں۔ ایویں سیٹ کرو: \"عید لئی 20000 سیو کرنے نیں\"۔",
        "goal_status_header": "🎯 تہاڈے سیونگز گولز:",
        "goal_row":         "• {name}: {saved:g}/{target:g} روپے جمع ہو چکے ({pct:.0f}%)",
        "goal_not_found": "🤔 مینوں اوہ گول نئیں لبھا۔ 'goal status' نال ناں چیک کرو۔",
        "goal_contributed": "✅ {name} وچ {amt:g} روپے ایڈ ہو گئے۔ {saved:g}/{target:g} روپے سیو ہو چکے، {remaining:g} روپے باقی۔",
        "streak_suffix":    "🔥 {n} دن توں لگاتار!",
        "reminder_set":    "⏰ یاد سیٹ: {title}",
        "reminder_fire":   "🚨 یاد: {title}",
        "reminder_confirm_ask": "🚨 یاد: {title}۔ ادا کر دتا؟ جے ہاں تاں امونٹ بھیج دینا، جا 'نئیں' لکھ دینا۔",
        "reminder_confirm_no_ack": "👍 کوئی گل نئیں، اگلی واری فیر یاد کرا دیواں گا۔",
        "reminder_settled": "ریمائنڈر وی کلیئر ہو گیا: {title}",
        "monthly_summary_header": "📅 تہاڈا {month} دا خلاصہ: {total:g} روپے خرچ ہوئے ({n} اندراجات)",
        "chart_title": "کیٹیگری دے حساب نال خرچہ",
        "chart_sent": "📊 ایہ ریا تہاڈا سپینڈنگ چارٹ!",
        "no_reminders": "📭 تہاڈے کول کوئی ایکٹو ریمائنڈر نئیں۔",
        "reminders_header": "⏰ تہاڈے ریمائنڈرز:",
        "transactions_header": "🧾 تہاڈی حالیہ ٹرانزیکشنز:",
        "referral_link_sent": "🎁 کسے دوست نوں انوائٹ کرو! ایہ لنک شیئر کرو — جدوں اوہ اپنا پہلا خرچ لاگ کرے گا، تہانوں دوواں نوں 7 دن دی پریمیم فری ملے گی:\n{link}",
        "referral_welcome": "👋 سرّاف بوٹ وچ خوش آمدید! تہانوں اک دوست نے انوائٹ کیتا اے۔ اپنا پہلا خرچ لاگ کرو تے 7 دن دی فری پریمیم ان لاک کرو — تہاڈے دوواں لئی!",
        "already_referred": "تسی پہلاں ہی اک ریفرل بونس استعمال کر چکے او، اس لئی ایہ کاؤنٹ نئیں ہووے گا — پر سرّاف بوٹ استعمال کرن دا شکریہ! 😊",
        "referral_already_claimed": "تہاڈے دوست نے پہلاں ہی اک ریفرل بونس لے لیا اے، اس لئی ایہ انوائٹ اس واری کاؤنٹ نئیں ہویا۔",
        "referral_reward_granted": "🎉 تہاڈی ریفرل کرکے 7 دن دی پریمیم فری مل گئی!",
        "dashboard_link_sent": "🔗 ایہ ریا تہاڈا ڈیش بورڈ: {link}\nایہ لنک 24 گھنٹے تک کم کرے گا۔",
        "budget_limit_reached": "⚠️ فری پلان وچ {limit} بجٹ کیٹیگریز تک اجازت اے۔ ان لمیٹڈ بجٹس لئی پریمیم لاؤ۔",
        "reminder_limit_reached": "⚠️ فری پلان وچ {limit} ایکٹو ریمائنڈرز تک اجازت اے۔ ان لمیٹڈ ریمائنڈرز لئی پریمیم لاؤ۔",
        "export_premium_only": "📄 تفصیلی رپورٹس (CSV/PDF) پریمیم فیچر اے۔ 299 روپے ماہانہ وچ پریمیم لاؤ۔",
        "history_limited_notice": "(فری پلان صرف پچھلے 3 مہینے دکھاندا اے — پوری ہسٹری لئی پریمیم لاؤ۔)",
        "no_expenses":     "📊 {scope} تے کوئی خرچہ نئیں لبھا{when}۔",
        "spent_summary":   "📊 تسی {total:g} روپے خرچ کیتے{when} ({n} اندراجات):",
        "and_more":        "• …تے {n} ہور",
        "all_categories":  "ساریاں کیٹیگریز",
        "today":           "اج", "yesterday": "کل (لنگھیا)",
        "this_week":       "اس ہفتے", "this_month": "اس مہینے",
        "this_year":       "اس سال", "all_time": "",
        "fallback_sorry":  "⚠️ معافی، سمجھ نئیں آئی۔ دوبارہ کوشش کرو۔",
        "dead_letter":     "معافی، ایہ پیغام پراسیس نئیں ہو سکیا۔ مہربانی کر کے دوبارہ بھیجو۔",
        "welcome":         "\U0001f44b ست سری اکال / السلام علیکم! میں سرّاف بوٹ ہاں — تہاڈا ڈیجیٹل منشی واٹس ایپ تے۔\n\nمینوں ایویں میسج کرو:\n\U0001f4b8 \"50 چاۓ\" — خرچہ لکھن لئی\n\U0001f4b0 \"بیلنس\" — اپنا بیلنس ویکھن لئی\n\U0001f4ca \"اس مہینے کتنا خرچ ہویا\" — حساب لئی\n\U0001f3af \"کھانے دا بجٹ 5000\" — بجٹ سیٹ کرن لئی\n\u23f0 \"کل بجلی دا بل یاد کرانا\"\n\nتسی ٹیکسٹ، وائس نوٹ، جا رسید دی فوٹو بھیج سکدے او — انگلش، اردو جا پنجابی وچ!",
        "categories_header": "\U0001f4cb ایہ ساری کیٹیگریز نیں جو میں ٹریک کردا ہاں:",
        "undo_confirm": "\U0001f5d1\ufe0f ہٹا دتا: {desc} ({sign}{amt:g} روپے)۔ جدوں مرضی صحیح اینٹری بھیج دیو۔",
        "undo_empty": "ہالے undo کرن لئی کجھ نئیں — کجھ لکھیا ہی نئیں۔",
        "ask_format": "\U0001f4c4 CSV چاہیدا یا PDF؟",
        "export_sent": "\u2705 تہاڈی رپورٹ بھیج دتی گئی اے۔",
        "export_empty": "ہالے export کرن لئی کجھ نئیں — کجھ لکھیا ہی نئیں۔",
        "export_failed": "\u26a0\ufe0f رپورٹ بھیجن ویلے مسئلہ ہویا۔ دوبارہ کوشش کرو۔",
    },
...
def handle_visualize(user: str, item: dict[str, Any], lang: str = "en") -> str:
    ...
    labels = [_translate_category(label, lang) if lang in ("roman_ur", "roman_pa") else label for label, _ in top]
